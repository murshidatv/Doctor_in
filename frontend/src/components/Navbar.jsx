      ...
      <div className="flex item-center gap-4">
        ...
        {token && userData ? (
          ...
          >
            ...
            {showDropdown && (
              <div className="absolute top-10 right-0 text-base font-medium text-gray-600 z-20 bg-stone-100 rounded flex flex-col gap-4 p-4 min-w-48">
                <p
                  onClick={() => {
                    navigate("my-profile");
          ...
          <button
            ...
            className="bg-primary text-white px-8 py-3 rounded-full font-light hidden 
        md:block"
          >
            Create Account
          </button>
